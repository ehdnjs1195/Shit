                            ...
                            <table class="table table-bordered">
                                ...
                                <c:forEach var="boardVO" varStatus="i" items="${list}">
                                    <tr>
                                        ...
                                        <td>
                                            <a href="${pageContext.request.contextPath}/board/read${pageMaker.makeSearch(pageMaker.criteria.page)}&board_num=${boardVO.board_num}">${boardVO.board_title}
                                                <%-- <span class="label label-warning">${boardVO.replycnt}</span> --%>
                                            </a>
                                        </td>
                                        <td>${boardVO.board_writer}</td>
                                        <td><fmt:formatDate pattern="yyyy-MM-dd HH:mm" value="${boardVO.board_regdate}"/></td>
                                        <td><span class="badge bg-aqua">${boardVO.board_view_count}</span></td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                            </table>
